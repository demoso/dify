...
if (
  ...
  apiPrefix = "http://111.231.217.197:6080/console/api";
  publicApiPrefix = "http://172.16.31.10:6080/api";
...
if (
  ...
  globalThis.document?.body?.getAttribute("data-public-max-tools-num") &&
  globalThis.document.body.getAttribute("data-public-max-tools-num") !== ""
)
  maxToolsNum = Number.parseInt(
    globalThis.document.body.getAttribute("data-public-max-tools-num") as string
  );
...
if (
  ...
  loopNodeMaxCount = Number.parseInt(
    process.env.NEXT_PUBLIC_LOOP_NODE_MAX_COUNT
  );
else if (
  globalThis.document?.body?.getAttribute("data-public-loop-node-max-count") &&
  globalThis.document.body.getAttribute("data-public-loop-node-max-count") !==
    ""
)
  loopNodeMaxCount = Number.parseInt(
    globalThis.document.body.getAttribute(
      "data-public-loop-node-max-count"
    ) as string
  );
...
if (
  ...
  maxIterationsNum = Number.parseInt(
    process.env.NEXT_PUBLIC_MAX_ITERATIONS_NUM
  );
else if (
  globalThis.document?.body?.getAttribute("data-public-max-iterations-num") &&
  globalThis.document.body.getAttribute("data-public-max-iterations-num") !== ""
)
  maxIterationsNum = Number.parseInt(
    globalThis.document.body.getAttribute(
